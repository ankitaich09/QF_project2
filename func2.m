...
for b, c & A in function 2 
 ...
 fid = fopen('fun2_A.txt','r');
  ...
  fclose(fid);
   ...
   - The gradient and Hessian of function 2 is given in project description. Hint: you should use
 vector & matrix calculation in your code as much as possible, instead of accessing to the elements in 
the vectors or matrices. The matlab expression of the function, its gradient and Hessian is basically 
